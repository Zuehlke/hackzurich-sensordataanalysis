...
class MotionReadingTest extends FlatSpec with Matchers {

  "from" should "parse MotionReading json with correct format" in {
    val tuple = Tuple2("key123",
      Map("date" -> "3.3.2016",
        "attitude" -> Map(
          "quaternion" -> Map("x" -> 1.1, "w" -> 1.2, "y" -> 2.2, "z" -> 3.3),
          "rotationMatrix" -> Map("m13" -> 4.4, "m12" -> 5.5, "m33" -> 6.6, "m32" -> 7.7, "m31" -> 8.8, "m21" -> 9.9, "m11" -> 10.0, "m22" -> 11.1, "m23" -> 12.2),
          "pitch" -> 13.3,
          "yaw" -> 14.4,
          "roll" -> 15.5
        )))

    val motionReading = MotionReading.from(tuple)
  ...
  it should "be None for MotionReading json being in wrong format with invalid inner map" in {
    val tuple = Tuple2("key123",
      Map("date" -> "3.3.2016",
        "attitude" -> Map(
          "quaternion" -> Map("x" -> "notADouble", "w" -> 1.2, "y" -> 2.2, "z" -> 3.3),
          "rotationMatrix" -> Map("m13" -> 4.4, "m12" -> 5.5, "m33" -> 6.6, "m32" -> 7.7, "m31" -> 8.8, "m21" -> 9.9, "m11" -> 10.0, "m22" -> 11.1, "m23" -> 12.2),
          "pitch" -> 13.3,
          "yaw" -> 14.4,
          "roll" -> 15.5
